...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var WebService_1 = __webpack_require__(7);
	var DataTableController_1 = __webpack_require__(9);
	var UserRowDirective_1 = __webpack_require__(10);
	// TODO: split controller into a different file
	// TODO: add tests
	angular.module('app', [WebService_1.default.name, UserRowDirective_1.default.name])
	    .controller('DataTableCtrl', DataTableController_1.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WebService = (function () {
	    ...
	    WebService.prototype.fetchInitialData = function () {
	        return this.$http.get(config_1.default.urls.initalData);
	    };
	    WebService.prototype.edit = function (user) {
	        var url = config_1.default.urls.edit + user.id;
	        return this.$http.post(url, user);
	    };
	    WebService.prototype.findAll = function (idArr) {
	        var params = {
	            ids: idArr.join(',')
	        };
	        return this.$http.get(config_1.default.urls.findAll, params);
	    };
	    WebService.prototype.find = function (id) {
	        var params = {
	            id: id
	        };
	        return this.$http.get(config_1.default.urls.find, { params: params });
	    };
	    WebService.prototype.remove = function (user) {
	        var url = config_1.default.urls.remove + user.id;
	        return this.$http.post(url, user);
	    };
	    return WebService;
	}());
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = angular.module('WebServiceModule', ['ngResource'])
	    .factory('WebService', function ($http) { return new WebService($http); });
...
/***/ function(module, exports) {
	...
	var DataTableController = (function () {
	    function DataTableController(WebService) {
	    ...
	    DataTableController.prototype.userRemove = function (index) {
	    ...
	    DataTableController.prototype.userSave = function (index) {
	        var user = this.users[index];
	        user.frozen = true;
	    ...
	    DataTableController.prototype.saveSelected = function () {
	    ...
	    DataTableController.prototype.handleInitialData = function (response) {
	        if (response.status === 200 && response.data.users)
	            this.users = response.data.users.map(function (user) {
	                user.selected = false;
	                user.edited = false;
	                user.frozen = false;
	                return user;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function UserRowController(scope) {
	    ...
	    scope.$watch('user.edited', function (value) {
	        if (value === true)
	            scope.createBackup();
	        else
	            scope.cancelEdit();
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = angular.module('UserRowModule', [])
...
/***/ function(module, exports) {
	...
	module.exports = "<tr ng-class=\"{'table-active': user.selected && !user.frozen, 'table-warning': user.frozen}\">\r\n    <td>\r\n        <input type=\"checkbox\" ng-model=\"user.selected\" ng-disabled=\"user.frozen\">\r\n    </td>\r\n    <td>\r\n        {{user.id}}\r\n    </td>\r\n    <td>\r\n        <span ng-show=\"!user.edited\">\r\n            {{user.name}}\r\n        </span>\r\n        <input type=\"text\" class=\"form-control\" ng-model=\"user.name\" ng-show=\"user.edited\" ng-disabled=\"user.frozen\">\r\n    </td>\r\n    <td>\r\n        <span ng-show=\"!user.edited\">\r\n            {{user.surname}}\r\n        </span>\r\n        <input type=\"text\" class=\"form-control\" ng-model=\"user.surname\" ng-show=\"user.edited\" ng-disabled=\"user.frozen\">\r\n    </td>\r\n    <td>\r\n        <span ng-show=\"!user.edited\">\r\n            {{user.birthDate}}\r\n        </span>\r\n        <input type=\"text\" class=\"form-control\" ng-model=\"user.birthDate\" ng-show=\"user.edited\" ng-disabled=\"user.frozen\">\r\n    </td>\r\n    <td>\r\n        <span ng-show=\"!user.edited\">\r\n            {{user.mobile}}\r\n        </span>\r\n        <input type=\"text\" class=\"form-control\" ng-model=\"user.mobile\" ng-show=\"user.edited\" ng-disabled=\"user.frozen\">\r\n    </td>\r\n    <td>\r\n        <span ng-show=\"!user.edited\">\r\n            {{user.address}}\r\n        </span>\r\n        <input type=\"text\" class=\"form-control\" ng-model=\"user.address\" ng-show=\"user.edited\" ng-disabled=\"user.frozen\">\r\n    </td>\r\n    <td>\r\n        <span ng-show=\"!user.edited\">\r\n            <!-- TODO: add click events on these buttons -->\r\n            <button role=\"button\" class=\"btn btn-primary\" ng-click=\"user.edited = true\" ng-disabled=\"user.frozen\">Edit</button>\r\n            <button role=\"button\" class=\"btn btn-danger\" ng-click=\"remove()\" ng-disabled=\"user.frozen\">Remove</button>\r\n        </span>\r\n        <span ng-show=\"user.edited\">\r\n            <!-- TODO: add click events on these buttons -->\r\n            <button role=\"button\" class=\"btn btn-primary\" ng-click=\"save()\" ng-disabled=\"user.frozen\">Save</button>\r\n            <button role=\"button\" class=\"btn btn-secondary\" ng-click=\"user.edited = false\" ng-disabled=\"user.frozen\">Cancel</button>\r\n        </span>\r\n    </td>\r\n</tr>";
